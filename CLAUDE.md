...
- Still `402`: the opaque EVM `400 contract_call_failed (ref)`, which a used authorization and an invalid signature share. Pinned in `tests/test_integrations_undelivered.py` (with mutations) and `tests/test_integrations_replay.py`
